...
namespace OnSale.Web.Data
{
    public class SeedDb
    {
        ...
        private async Task<User> CheckUserAsync(
                ...
                UserType userType)
        {
            User user = await _userHelper.GetUserAsync(email); //busca el user
            if (user == null) //si no existe
            {
                user = new User //crea un nuevo user
                {
                    FirstName = firstName,
                    LastName = lastName,
                    Email = email,
                ...
                await _userHelper.AddUserToRoleAsync(user, userType.ToString()); //AddUserToRoleAsync adiciona el role al userType
            }
